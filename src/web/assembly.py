...
def register_builtin_endpoints(app: FastAPI) -> None:
    ...
    async def login_submit(request: Request, password: str = Form(...), next: str = Form("/")):
        ...
        if expected_password and secrets.compare_digest(password.encode(), expected_password.encode()):
...
def register_routes(app: FastAPI) -> None:
    ...
    from src.web.routes.export import router as export_router
    ...
    app.include_router(export_router, prefix="/channels")
