...
def register(subparsers: argparse._SubParsersAction) -> argparse.ArgumentParser | None:
    ...
    my_tg_react = dialogs_sub.add_parser("react", help="Set or clear your reaction on a message")
    ...
    my_tg_react.add_argument("emoji", nargs="?", help="Reaction emoji to set; required unless --clear is used")
