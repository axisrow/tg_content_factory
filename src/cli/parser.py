...
def build_parser() -> argparse.ArgumentParser:
    ...
    my_tg_pin = my_tg_sub.add_parser("pin-message", help="Pin a message in a chat")
    ...
    my_tg_unpin = my_tg_sub.add_parser("unpin-message", help="Unpin a message in a chat")
    ...
    my_tg_dl = my_tg_sub.add_parser("download-media", help="Download media from a message")
    ...
    my_tg_bstats = my_tg_sub.add_parser("broadcast-stats", help="Get broadcast statistics for a channel")
    ...
    my_tg_archive = my_tg_sub.add_parser("archive", help="Archive a dialog (move to archive folder)")
    ...
    my_tg_unarchive = my_tg_sub.add_parser("unarchive", help="Unarchive a dialog (move to main folder)")
    ...
    my_tg_mark_read = my_tg_sub.add_parser("mark-read", help="Mark messages as read in a chat")
