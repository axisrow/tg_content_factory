...
PROVIDER_SPECS: dict[str, ProviderSpec] = {
    "openai": ProviderSpec(
        ...
        plain_fields=(
            _field("base_url", "Base URL", placeholder="https://api.openai.com/v1"),
        ),
    ),
    "anthropic": ProviderSpec(
        ...
        static_models=("claude-sonnet-4-5-20250929", "claude-opus-4-1", "claude-haiku-4-5-20251001"),
        secret_fields=(
            _field("api_key", "API key", required=True, secret=True),
        ),
    ),
    ...
    "bedrock": ProviderSpec(
        ...
        plain_fields=(
            _field("region_name", "Region", required=True, placeholder="us-east-1"),
        ),
    ),
    ...
    "fireworks": ProviderSpec(
        ...
        static_models=("accounts/fireworks/models/llama-v3p1-8b-instruct", "accounts/fireworks/models/qwen3-235b-a22b"),
        secret_fields=(
            _field("api_key", "API key", required=True, secret=True),
        ),
        plain_fields=(
    ...
    "together": ProviderSpec(
        ...
        static_models=("meta-llama/Llama-3.3-70B-Instruct-Turbo", "Qwen/Qwen2.5-72B-Instruct-Turbo"),
        secret_fields=(
            _field("api_key", "API key", required=True, secret=True),
        ),
    ),
    ...
    "huggingface": ProviderSpec(
        ...
        secret_fields=(
            _field("api_key", "API token", secret=True),
        ),
    ),
    "groq": ProviderSpec(
        name="groq",
    ...
    "ollama": ProviderSpec(
        ...
        plain_fields=(
            _field(
                "base_url",
                "Base URL",
                placeholder="http://localhost:11434, http://localhost:11434/api, https://ollama.com, or https://ollama.com/api",
                help_text="Accepts both host and /api forms. Empty uses local Ollama by default, or Ollama Cloud when API key is set.",
            ),
        ),
        secret_fields=(
            _field(
