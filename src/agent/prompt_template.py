...
DEFAULT_AGENT_PROMPT_TEMPLATE = (
    ...
    "3. Выстраивай цепочки инструментов для сложных задач: "
    "например, контент-план = search_telegram + WebSearch + generate_draft + generate_image.\n"
    "4. Будь проактивным: предлагай идеи, если пользователю не хватает фантазии — помоги придумать.\n"
    "5. На вопрос «Что ты можешь?» — расскажи о своих возможностях.\n\n"
