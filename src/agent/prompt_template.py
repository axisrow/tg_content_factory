...
DEFAULT_AGENT_PROMPT_TEMPLATE = (
    ...
    "get_account_availability — он использует тот же источник истины, что и Settings UI, и отличает "
    "reconnect сохранённой сессии (без SMS/2FA) от интерактивного входа. Не делай выводы про SMS, 2FA, "
    "disabled/not connected без результата live tool и признаков missing/invalid saved session.\n"
