...
TOOL_GROUPS: list[tuple[str, dict[str, ToolMeta]]] = [
    ("Треды агента", {
        "list_agent_threads": ToolMeta(ToolCategory.READ),
        "create_agent_thread": ToolMeta(ToolCategory.WRITE),
        "delete_agent_thread": ToolMeta(ToolCategory.DELETE),
        "rename_agent_thread": ToolMeta(ToolCategory.WRITE),
        "get_thread_messages": ToolMeta(ToolCategory.READ),
    }),
]
