...
CLI_REAL_TG_MANUAL_OR_EXCLUDED_COMMANDS: dict[tuple[str, ...], str] = {
    ...
    ("dialogs", "delete"): "cleanup-only live CLI command; permanently deletes a channel/group created during the test",
    ...
    ("pipeline", "select-variant"): "local run mutation (sets selected A/B variant)",
    ("pipeline", "toggle"): "local pipeline state mutation",
    ("pipeline", "variants"): "list-only but depends on a prior provider-spend A/B run",
