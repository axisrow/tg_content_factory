...
| ✅ | поверхность есть |
| — | поверхности нет |
| ⚠️ | **пробел parity** — функция есть в др. поверхностях, тут неоправданно забыта |
